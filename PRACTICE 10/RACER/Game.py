...
pygame.mixer.music.load(r"PRACTICE 10\RACER\background.wav") 
...
background = pygame.image.load(r"PRACTICE 10\RACER\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"PRACTICE 10\RACER\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"PRACTICE 10\RACER\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Отрисовка желтой монетки
        pygame.draw.circle(self.image, (255, 223, 0), (17, 17), 17) 
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          ...
          pygame.mixer.Sound(r'PRACTICE 10\RACER\crash.wav').play()
          time.sleep(0.5)
